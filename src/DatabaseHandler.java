...
public class DatabaseHandler {
    ...
    public List<String[]> getTransactions(String userID) {
        ...
        String query = "SELECT id_transaksi, id_pelanggan, id_pengiriman, id_voucher, tanggal, total_harga, total_berat, potongan_harga, status FROM transaksi WHERE id_pelanggan = ?";
        ...
        try (PreparedStatement ps = conn.prepareStatement(query)) {
            ...
            while (rs.next()) {
                transactions.add(new String[]{
                    rs.getString(1), // id_transaksi
                    rs.getString(2), // id_pelanggan
                    rs.getString(3), // id_pengiriman
                    rs.getString(4), // id_voucher
                    rs.getString(5), // tanggal_transaksi
                    rs.getString(6), // total_harga
                    rs.getString(7), // total_berat
                    rs.getString(8), // potongan_harga
